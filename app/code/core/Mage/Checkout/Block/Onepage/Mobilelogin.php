 ...
 */
class Mage_Checkout_Block_Onepage_MobileLogin extends Mage_Checkout_Block_Onepage_Abstract
{
    ...
    {
        return Mage::getUrl('customer/account/mobileloginPost', array('_secure'=>true));
    }
