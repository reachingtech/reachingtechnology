...
('FR', '13', 'Bouches-du-Rh?ne'),('FR', '14', 'Calvados'),('FR', '15', 'Cantal'),
('FR', '16', 'Charente'),('FR', '17', 'Charente-Maritime'),('FR', '18', 'Cher'),
('FR', '19', 'Corrèze'),('FR', '2A', 'Corse-du-Sud'),('FR', '2B', 'Haute-Corse'),
('FR', '21', 'C?te-d\\'Or'),('FR', '22', 'C?tes-d\\'Armor'),('FR', '23', 'Creuse'),
('FR', '24', 'Dordogne'),('FR', '25', 'Doubs'),('FR', '26', 'Dr?me'),
...
('FR', '63', 'Puy-de-D?me'),('FR', '64', 'Pyrénées-Atlantiques'),('FR', '65', 'Hautes-Pyrénées'),
('FR', '66', 'Pyrénées-Orientales'),('FR', '67', 'Bas-Rhin'),('FR', '68', 'Haut-Rhin'),
('FR', '69', 'Rh?ne'),('FR', '70', 'Haute-Sa?ne'),('FR', '71', 'Sa?ne-et-Loire'),
...
$regionsToIns = array(
    array('RO', 'AB', 'Alba'), array('RO', 'AR', 'Arad'), array('RO', 'AG', 'Arge?'),
    array('RO', 'BC', 'Bac?u'), array('RO', 'BH', 'Bihor'), array('RO', 'BN', 'Bistri?a-N?s?ud'),
    array('RO', 'BT', 'Boto?ani'), array('RO', 'BV', 'Bra?ov'), array('RO', 'BR', 'Br?ila'),
    array('RO', 'B', 'Bucure?ti'), array('RO', 'BZ', 'Buz?u'), array('RO', 'CS', 'Cara?-Severin'),
    array('RO', 'CL', 'C?l?ra?i'), array('RO', 'CJ', 'Cluj'), array('RO', 'CT', 'Constan?a'),
    array('RO', 'CV', 'Covasna'), array('RO', 'DB', 'Dambovi?a'), array('RO', 'DJ', 'Dolj'),
    array('RO', 'GL', 'Gala?i'), array('RO', 'GR', 'Giurgiu'), array('RO', 'GJ', 'Gorj'),
    array('RO', 'HR', 'Harghita'), array('RO', 'HD', 'Hunedoara'), array('RO', 'IL', 'Ialomi?a'),
    array('RO', 'IS', 'Ia?i'), array('RO', 'IF', 'Ilfov'), array('RO', 'MM', 'Maramure?'),
    array('RO', 'MH', 'Mehedin?i'), array('RO', 'MS', 'Mure?'), array('RO', 'NT', 'Neam?'),
    array('RO', 'OT', 'Olt'), array('RO', 'PH', 'Prahova'), array('RO', 'SM', 'Satu-Mare'),
    array('RO', 'SJ', 'S?laj'), array('RO', 'SB', 'Sibiu'), array('RO', 'SV', 'Suceava'),
    array('RO', 'TR', 'Teleorman'), array('RO', 'TM', 'Timi?'), array('RO', 'TL', 'Tulcea'),
    array('RO', 'VS', 'Vaslui'), array('RO', 'VL', 'Valcea'), array('RO', 'VN', 'Vrancea')
);
...
$regionsToIns = array(
    ...
    array('FI', 'Etel?-Savo', 'Etel?-Savo'),
    array('FI', 'Etel?-Pohjanmaa', 'Etel?-Pohjanmaa'),
    ...
    array('FI', 'Etel?-Karjala', 'Etel?-Karjala'),
    array('FI', 'P?ij?t-H?me', 'P?ij?t-H?me'),
    array('FI', 'Kanta-H?me', 'Kanta-H?me'),
    array('FI', 'Uusimaa', 'Uusimaa'),
    array('FI', 'It?-Uusimaa', 'It?-Uusimaa'),
    ...
    array('EE', 'EE-49', 'J?gevamaa'),
    array('EE', 'EE-51', 'J?rvamaa'),
    array('EE', 'EE-57', 'L??nemaa'),
    array('EE', 'EE-59', 'L??ne-Virumaa'),
    array('EE', 'EE-65', 'P?lvamaa'),
    array('EE', 'EE-67', 'P?rnumaa'),
    array('EE', 'EE-70', 'Raplamaa'),
    array('EE', 'EE-74', 'Saaremaa'),
    array('EE', 'EE-78', 'Tartumaa'),
    array('EE', 'EE-82', 'Valgamaa'),
    array('EE', 'EE-84', 'Viljandimaa'),
    array('EE', 'EE-86', 'V?rumaa'),
    ...
    array('LV', 'Grobi?as novads', 'Grobi?as novads'),
    array('LV', 'LV-GU', 'Gulbenes novads'),
    array('LV', 'Iecavas novads', 'Iecavas novads'),
    array('LV', 'Ik??iles novads', 'Ik??iles novads'),
    array('LV', 'Ilūkstes novads', 'Ilūkstes novads'),
    array('LV', 'In?ukalna novads', 'In?ukalna novads'),
    ...
    array('LV', 'Nauk?ēnu novads', 'Nauk?ēnu novads'),
    ...
    array('LV', 'Stopi?u novads', 'Stopi?u novads'),
    array('LV', 'Stren?u novads', 'Stren?u novads'),
    ...
    array('LV', 'Vai?odes novads', 'Vai?odes novads'),
    array('LV', 'LV-VK', 'Valkas novads'),
    array('LV', 'LV-VM', 'Valmieras novads'),
    array('LV', 'Varak?ānu novads', 'Varak?ānu novads'),
    ...
    array('LV', 'Vi?akas novads', 'Vi?akas novads'),
    array('LV', 'Vi?ānu novads', 'Vi?ānu novads'),
    array('LV', 'Vārkavas novads', 'Vārkavas novads'),
    array('LV', 'Zilupes novads', 'Zilupes novads'),
    array('LV', 'āda?u novads', 'āda?u novads'),
    array('LV', 'ērg?u novads', 'ērg?u novads'),
    array('LV', '?eguma novads', '?eguma novads'),
    array('LV', '?ekavas novads', '?ekavas novads'),

    //ISO-3166-2:LT
    array('LT', 'LT-AL', 'Alytaus Apskritis'),
    array('LT', 'LT-KU', 'Kauno Apskritis'),
    array('LT', 'LT-KL', 'Klaip?dos Apskritis'),
    array('LT', 'LT-MR', 'Marijampol?s Apskritis'),
    array('LT', 'LT-PN', 'Panev??io Apskritis'),
    array('LT', 'LT-SA', '?iauli? Apskritis'),
    array('LT', 'LT-TA', 'Taurag?s Apskritis'),
    array('LT', 'LT-TE', 'Tel?i? Apskritis'),
