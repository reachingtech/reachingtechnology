...
class AHT_Aslideshow_Block_Adminhtml_Slideshow_Edit_Tab_Category extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('aht_aslideshow/edit/tab/category.phtml');
    }
